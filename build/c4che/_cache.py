...
EXAMPLE_DIRECTORIES = ['tcp', 'traffic-control', 'udp-client-server', 'tutorial', 'routing', 'ipv6', 'wireless', 'udp', 'stats', 'realtime', 'energy', 'error-model', 'socket', 'naming', 'matrix-topology']
...
NS3_EXECUTABLE_PATH = ['/root/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/root/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/root/ns-allinone-3.29/ns-3.29/build/lib']
...
cfg_files = ['/root/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/root/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
